%{
varprecision.FitPredictionBpsBestAvg (computed) # compute fit predictions based on fit parameters found by bps method
...
classdef FitPredictionBpsBestAvg < dj.Relvar & dj.AutoPopulate
