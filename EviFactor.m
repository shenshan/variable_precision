...
classdef EviFactor < dj.Relvar & dj.AutoPopulate
    ...
    methods(Access=protected)
		...
		function makeTuples(self, key)
            ...
            [dn_aicMat, dn_bicMat, dn_aiccMat, dn_llmaxMat] = fetchn(varprecision.FitParsEviBpsBestAvg & key & 'model_name in ("CPN","CPGN","VPN","VPGN","OPN","OPGN","OPVPN","OPVPGN")','aic','bic','aicc','llmax');
            [non_dn_aicMat, non_dn_bicMat, non_dn_aiccMat, non_dn_llmaxMat] = fetchn(varprecision.FitParsEviBpsBestAvg & key & 'model_name in ("CP","CPG","VP","VPG","OP","OPG","OPVP","OPVPG")','aic','bic','aicc','llmax');
            [total_var_aicMat, total_var_bicMat, total_var_aiccMat, total_var_llmaxMat] = fetchn(varprecision.FitParsEviBpsBestAvg & key & 'model_name in ("OPVP","OPVPN","OPVPG","OPVPGN")','aic','bic','aicc','llmax');
            [non_total_var_aicMat, non_total_var_bicMat, non_total_var_aiccMat, non_total_var_llmaxMat] = fetchn(varprecision.FitParsEviBpsBestAvg & key & 'model_name in ("CP","CPN","CPG","CPGN")','aic','bic','aicc','llmax');
