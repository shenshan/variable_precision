function [K,dK] = covMaternard_fast(d, hyp, x, z, i)
...
if dg                                                               % vector kxx
  ...
  if xeqz                                                 % symmetric matrix Kxx
    M = sq_dist(diag(sqrt(d)./ell)*x');
  else                                                   % cross covariances Kxz
    M = sq_dist(diag(sqrt(d)./ell)*x',diag(sqrt(d)./ell)*z');
  end
end
