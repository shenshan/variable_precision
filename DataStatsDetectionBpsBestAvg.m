%{
varprecision.DataStatsDetectionBpsBestAvg(computed) # compute data statistics and prediction statistics for detection tasks, ready for plotting
...
classdef DataStatsDetectionBpsBestAvg < dj.Relvar & dj.AutoPopulate
	
    properties
        popRel = varprecision.FitPredictionBpsBestAvg & 'exp_id in (10,11,12)'
    end
