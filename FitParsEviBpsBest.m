	...
	methods(Access=protected)
		...
		function makeTuples(self, key)
            ...
            [key.best_int_pnt_idx,key.best_run_idx,...
             key.p_right_hat,key.lambda_hat,key.theta_hat,key.beta_hat,key.guess_hat,...
             key.llmax,key.bic,key.aic,key.aicc] = fetch1(varprecision.FitParsEviBpsRun & tuples(idx),... 
             'int_point_id','run_idx','p_right_hat','lambda_hat','theta_hat','beta_hat','guess_hat','llmax','bic','aic','aicc');
