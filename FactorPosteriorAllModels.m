%{
varprecision.FactorPosteriorAllModels (computed) # compute factor posteriror by marginalizing over all models including those suboptimal ones
-> varprecision.Data
-----
...
classdef FactorPosteriorAllModels < dj.Relvar & dj.AutoPopulate
    ...
    methods(Access=protected)
		...
		function makeTuples(self, key)
            ...
            models_total_var = fetch(varprecision.Model & key & 'factor_code like "%OV%"' & models);
            models_non_total_var = fetch(varprecision.Model & key & 'factor_code not like "%O%"' & 'factor_code not like "%V"' & models);
