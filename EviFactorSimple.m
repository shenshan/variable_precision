%{
varprecision.EviFactorSimple (computed) # compute marginal posterior of each factor, extract data from table FitParsEviBpsBest
-> varprecision.Data
-----
...
classdef EviFactorSimple < dj.Relvar & dj.AutoPopulate
    ...
    methods(Access=protected)
		...
		function makeTuples(self, key)
            [ori_aicMat, ori_bicMat, ori_aiccMat, ori_llmaxMat] = fetchn(varprecision.FitParsEviBpsBest & key & 'model_name in ("OP","OPN","OPG","OPGN","OPVP","OPVPN","OPVPG","OPVPGN")','aic','bic','aicc','llmax');
            [non_ori_aicMat, non_ori_bicMat, non_ori_aiccMat, non_ori_llmaxMat] = fetchn(varprecision.FitParsEviBpsBest & key & 'model_name in ("CP","CPN","CPG","CPGN","VP","VPN","VPG","VPGN")','aic','bic','aicc','llmax');
            ...
            [non_var_aicMat, non_var_bicMat, non_var_aiccMat, non_var_llmaxMat] = fetchn(varprecision.FitParsEviBpsBest & key & 'model_name in ("CP","CPN","CPG","CPGN","OP","OPN","OPG","OPGN")','aic','bic','aicc','llmax');
            [guess_aicMat, guess_bicMat, guess_aiccMat, guess_llmaxMat] = fetchn(varprecision.FitParsEviBpsBest & key & 'model_name in ("CPG","CPGN","VPG","VPGN","OPG","OPGN","OPVPG","OPVPGN")','aic','bic','aicc','llmax');
            [non_guess_aicMat, non_guess_bicMat, non_guess_aiccMat, non_guess_llmaxMat] = fetchn(varprecision.FitParsEviBpsBest & key & 'model_name in ("CP","CPN","VP","VPN","OP","OPN","OPVP","OPVPN")','aic','bic','aicc','llmax');
            [dn_aicMat, dn_bicMat, dn_aiccMat, dn_llmaxMat] = fetchn(varprecision.FitParsEviBpsBest & key & 'model_name in ("CPN","CPGN","VPN","VPGN","OPN","OPGN","OPVPN","OPVPGN")','aic','bic','aicc','llmax');
            [non_dn_aicMat, non_dn_bicMat, non_dn_aiccMat, non_dn_llmaxMat] = fetchn(varprecision.FitParsEviBpsBest & key & 'model_name in ("CP","CPG","VP","VPG","OP","OPG","OPVP","OPVPG")','aic','bic','aicc','llmax');
            [total_var_aicMat, total_var_bicMat, total_var_aiccMat, total_var_llmaxMat] = fetchn(varprecision.FitParsEviBpsBest & key & 'model_name in ("OPVP","OPVPN","OPVPG","OPVPGN")','aic','bic','aicc','llmax');
            [non_total_var_aicMat, non_total_var_bicMat, non_total_var_aiccMat, non_total_var_llmaxMat] = fetchn(varprecision.FitParsEviBpsBest & key & 'model_name in ("CP","CPN","CPG","CPGN")','aic','bic','aicc','llmax');
