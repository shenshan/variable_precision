...
for iexp = exp_ids
    ...
    switch type
        case 'aic'
            [g,o,d,v,ov] = fetchn(varprecision.EviFactor2 & ['exp_id=' num2str(iexp)], 'guess_aic','dn_aic','ori_aic','var_aic','total_var_aic');
        case 'bic'
            [g,o,d,v,ov] = fetchn(varprecision.EviFactor2 & ['exp_id=' num2str(iexp)], 'guess_bic','dn_bic','ori_bic','var_bic','total_var_bic');
    end
    g = g*2; d = d*2; o = o*2; v = v*2; ov = ov*2; 

    fid = fopen(['KOD_' type '.txt'],'a');
