function showFactorPosteriorStephanGOV
...
for ii = 1:length(exp_ids)
    ...
    [eviMat{ii,1},eviMat{ii,2},eviMat{ii,3},eviMat{ii,4}] = fetch1(varprecision.BmcGroupGOV & exp, 'fpp_g','fpp_o','fpp_v','fpp_ov');
...
fig.save('~/Dropbox/VR/+varprecision/figures/evi_factor_posterior_stephan_GOV')