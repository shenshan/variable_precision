function showModelComparisionGaussianFlat(exp,cmp_type)
...
models_sub = {'BaseFlat','VFlat','GFlat','GVFlat','OFlat','OVFlat','GOFlat','GOVFlat','DFlat','DVFlat','GDFlat','GDVFlat','DOFlat','DOVFlat','GOVFlat','GDOVFlat'};
...
fig.cleanup
fig.save(['~/Dropbox/VR/+varprecision/figures/exp_' num2str(exp.exp_id) '_' cmp_type '_GaussianFlat'])
