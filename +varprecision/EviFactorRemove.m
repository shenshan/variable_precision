%{
varprecision.EviFactorRemove (computed) # compute factorized evidences, difference in evidence between model with a factor versus not, lesion of different factors from the best model, extract data from table varprecision.FitParsEviBest.
-> varprecision.Data
-----
...
classdef EviFactorRemove < dj.Relvar & dj.AutoPopulate
