function [mean_evi, sem_evi, p1, p2, p3] = LFLRGV(type,exp_res)
...
switch type
    case 'aic'
        [eviMat(:,1),eviMat(:,2)] = fetchn(varprecision.EviFactorGV & records, 'g_lfpr_aic','v_lfpr_aic');
    case 'bic'
        [eviMat(:,1),eviMat(:,2)] = fetchn(varprecision.EviFactorGV & records, 'g_lfpr_bic','v_lfpr_bic');
end
eviMat = eviMat * 2;
