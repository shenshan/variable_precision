%{
varprecision.DataStatsDisc (computed) # compute data statistics and prediction statistics for detection tasks, ready for plotting
...
classdef DataStatsDisc < dj.Relvar & dj.AutoPopulate
	
    properties
        popRel = varprecision.FitPrediction & 'exp_id in (6,7,9)'
    end
